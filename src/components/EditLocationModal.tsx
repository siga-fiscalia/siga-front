...
export default function EditLocationModal({
  ...
  const handleSave = () => {
    ...
    const updatedLocation: PhysicalLocation = {
      ...location,
      tipo: formData.tipo,
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl h-[85vh] flex flex-col overflow-hidden border border-gray-200">
        ...
        <div className="flex items-center justify-between p-4 text-white border-b bg-gradient-to-r from-blue-600 to-blue-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg font-bold">Editar Ubicación Física</h2>
        ...
        {/* Información de la ubicación en header */}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="font-semibold text-blue-900">
                  Tipo: {location.tipo} - Sub Tipo: {location.subTipo}
                </p>
                <p className="text-sm text-blue-700">{location.descripcion}</p>
              </div>
            </div>
