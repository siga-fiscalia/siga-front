...
import { X, Building2, MapPin, Calendar, Phone } from "lucide-react";
...
interface NewCostCenterModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (newCostCenter: CostCenter) => void;
}

export default function NewCostCenterModal({
  isOpen,
  onClose,
  onSave,
}: NewCostCenterModalProps) {
  ...
  const handleSave = () => {
    ...
    if (
      ...
      alert(
        "Por favor complete los campos obligatorios: Código, Descripción, Dirección y Distrito"
      );
      return;
    }
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl h-[85vh] flex flex-col overflow-hidden border border-gray-200">
        ...
        <div className="flex items-center justify-between p-4 text-white border-b bg-gradient-to-r from-blue-600 to-blue-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg font-bold">Nuevo Centro de Costo</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="ambito" className="font-medium text-blue-800">
                    Ámbito
                  </Label>
                  <Select
